    ...
    <div class="main-content">
        <div class="wrapper">
                ...
                <table class = "tbl-30">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            // check weather the categories are availableor not
                            if($count>0){
            ...
            if(isset($_POST['submit']))
            {
                ...
                // checked weather the upload button is clicked or not
                if($_FILES['image']['name'] != "")
                {
                 ...
                 // image is available
                        ...
                        $dest_path = "../images/food/".$image_name; //destination department
